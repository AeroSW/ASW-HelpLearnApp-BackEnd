...
namespace ASW {
	class NeuralNetwork {
		...
		public:
			...
			virtual std::vector<double> feed(double *);
			virtual std::vector<double> getWeights(uint32_t, uint32_t); // layer, node
			...
			virtual void setWeights(uint32_t, uint32_t, double*);
